...
Vhcl_Init (void)
{
    ...
    if (!PowerTrainDisabled)
	Vehicle.EngineControl = Car_CM4SL_EngineControl;
...
#if !defined(WIN64) && !defined(INTIME) && !defined(ARTE_INTIME) && !defined(LVRT)
#if defined(WIN32)
    Tire_Register_TNO_MF61();
#endif
#endif

#if !defined(LINUX64) && !defined(WIN64) && !defined(DSPACE) && !defined(INTIME) && !defined(ARTE_INTIME)
